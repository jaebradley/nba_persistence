    ...
    if os.path.isfile(draftkings_file_name):
        with open(draftkings_file_name) as file:
            ...
            for salary in salaries:
                ...
                player = Player.objects.get_or_create(position__abbreviation=position, first_name=first_name, last_name=last_name, team__abbreviation=player_team_abbreviation)
    ...
    if os.path.isfile(fanduel_file_name):
        with open(fanduel_file_name) as file:
            ...
            for salary in salaries:
                ...
                player = Player.objects.get_or_create(position=position, first_name=first_name, last_name=last_name, team__abbreviation=player_team_abbreviation)
